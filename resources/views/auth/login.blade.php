...
<button type="button" class="flex items-center justify-center gap-sm py-md border border-outline-variant rounded-lg hover:bg-white/5 transition-colors active:scale-[0.98]">
<svg class="w-5 h-5" viewbox="0 0 24 24">
